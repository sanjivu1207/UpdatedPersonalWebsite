...
const socials = [
  { icon: <EmailIcon />, href: 'mailto:sanjiv1207@gmail.com', label: 'Send email' },
  { icon: <GithubIcon />, href: 'https://github.com/sanjivu1207', label: 'GitHub profile' },
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '0 24px' }}>
        ...
        >
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '1rem', lineHeight: 1.8, marginBottom: '40px' }}>
            Always open to research collaborations, internships, and interesting projects.

          </p>

          <motion.a
            href="mailto:Sanjiv1207@gmail.com"
            ...
            {terminalVisible && (
              ...
              >
                {[
                  ...
                  { label: 'Contact', value: 'Sanjiv1207@gmail.com', color: '#7c3aed' },
                ].map(r => (
